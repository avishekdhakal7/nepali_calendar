...
export default function StaffNoticesPage() {
  ...
  return (
    <StaffLayout title="Notices" activeRoute="/staff/notices">
      {/* Header */}
      <div className="relative max-w-md">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2 bg-zinc-900/60 border border-zinc-800/60 rounded-lg text-sm text-white placeholder-zinc-500 focus:outline-none focus:border-cyan-500/50"
        />
      </div>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    {notice.is_pinned && <span className="text-xs bg-cyan-500/20 text-cyan-400 px-2 py-0.5 rounded">Pinned</span>}
